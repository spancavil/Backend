...
const ProductosDAO = require('../persistence/productosDAO');

let productoDAO = ProductosDAO.getProductoDAOinstance();
let productoDAO2 = ProductosDAO.getProductoDAOinstance();

console.log("Es la instancia 1 igual a la instancia 2?: " + (productoDAO === productoDAO2));

console.log(productoDAO);
console.log(productoDAO2);
