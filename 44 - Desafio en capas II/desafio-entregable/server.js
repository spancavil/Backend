...
const routerGraphProductos = require('./routes/graphql');
const routerGraphMensajes = require('./routes/graphqlMensajes');
...
app.use('/', routerHome);
app.use('/graphqlProductos', routerGraphProductos);
app.use('/graphqlMensajes', routerGraphMensajes);
...
server.listen(config.PORT, () => {
  loggerConsole.log('debug', `Servidor escuchando en http://localhost:${config.PORT}`);
});